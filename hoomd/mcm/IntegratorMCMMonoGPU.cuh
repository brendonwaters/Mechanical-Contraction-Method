...
#ifndef _INTEGRATOR_MCM_CUH_
#define _INTEGRATOR_MCM_CUH_
...
//! Wraps arguments to gpu_mcm_up
/*! \ingroup mcm_data_structs */
struct mcm_args_t
    {
    //! Construct a pair_args_t
    mcm_args_t(Scalar4 *_d_postype,
    ...
    mcm_counters_t *d_counters;      //!< Move accept/reject counters
...
cudaError_t gpu_mcm_update(const mcm_args_t& args, const typename Shape::param_type *params);
...
*/
template< class Shape >
__global__ void gpu_mcm_mpmc_kernel(Scalar4 *d_postype,
...
cudaError_t gpu_mcm_update(const mcm_args_t& args, const typename Shape::param_type *params)
    ...
    if (max_block_size == -1)
        {
        cudaFuncGetAttributes(&attr, gpu_mcm_mpmc_kernel<Shape>);
    ...
    gpu_mcm_mpmc_kernel<Shape><<<grid, threads, shared_bytes, args.stream>>>(args.d_postype,
                                                                 args.d_orientation,
                                                                 args.d_counters,
                                                                 args.d_cell_idx,
                                                                 args.d_cell_size,
