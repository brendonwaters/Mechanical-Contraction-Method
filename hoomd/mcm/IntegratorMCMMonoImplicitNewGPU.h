...
IntegratorHPMCMonoImplicitNewGPU< Shape >::IntegratorHPMCMonoImplicitNewGPU(std::shared_ptr<SystemDefinition> sysdef,
    ...
    m_tuner_implicit.reset(new Autotuner(valid_params, 5, 1000000, "mcm_insert_depletants", this->m_exec_conf));
...
//                        detail::gpu_mcm_implicit_count_overlaps<Shape>(
                        detail::gpu_mcm_insert_depletants_queue<Shape>(
                            detail::mcm_implicit_args_new_t(d_postype.data,
                                d_orientation.data,
                                d_old_postype.data,
                        ...
                        detail::gpu_mcm_implicit_accept_reject_new<Shape>(
                            detail::mcm_implicit_args_new_t(d_postype.data,
                                d_orientation.data,
                                d_old_postype.data,
                                d_old_orientation.data,
