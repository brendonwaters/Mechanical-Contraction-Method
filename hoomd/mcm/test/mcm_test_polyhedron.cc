#include "hoomd/mcm/IntegratorMCM.h"
#include "hoomd/mcm/Moves.h"
#include "hoomd/mcm/ShapePolyhedron.h"
#include "hoomd/mcm/AABBTree.h"
...
GPUTree build_tree(poly3d_data &data)
    ...
    OBBTree tree;
    mcm::detail::OBB *obbs;
    int retval = posix_memalign((void**)&obbs, 32, sizeof(mcm::detail::OBB)*data.n_faces);
    if (retval != 0)
        {
